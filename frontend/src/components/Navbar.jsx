        ...
        <nav className="container mx-auto flex items-center justify-between p-5">
          <div>
            <Link to="/" className="text-blue-600 font-bold text-xl">
              Job Listing<span className="text-[#1677cccb]"> Portal</span>
            </Link>
          </div>
          ...
          <div className="hidden lg:block">
            {!user?.token ? (
              <Link to="/user-auth">
                <CustomButton
                  title="Sign In"
                  containerStyles="text-blue py-1.5 px-5 focus:outline-none hover:bg-blue hover:text-white rounded-full text-base border border-sky-800"
                />
              </Link>
            ) : (
              <div>
